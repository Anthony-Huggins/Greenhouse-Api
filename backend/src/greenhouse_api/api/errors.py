...
#EXAMPLE OF CUSTOM ERROR THAT CAN BE CALLED EXPLICITY IN OTHER CODE 
#
...
class ConflictError(DomainError):
    """Status code and error message for DomainEorrors """
    status_code = 409
    error_code = "conflict"
...
def register_error_handlers(app: Flask) -> None:
    ...
    def _validation(e: ValidationError):
        """Catch any valadion errors caused by pydantic"""
    ...
    def _domain(e: DomainError):
        """Catch any DomainErrors use base class to return nicely"""
        log.info("domain_error", error_code=e.error_code, **e.context)
        return e.envelope(), e.status_code

    @app.errorhandler(404)
    def _404(_e):
        """Catch any 404 request responces and use base class to return nicely"""
        return {"error": "route_not_found",
                "message": "no route matches this URL and method"}, 404

    @app.errorhandler(405)
    def _405(e):
        """Catch any 405 request responces and use base class to return nicely"""
    ...
    def _500(_e):
        """Catch any 500 request responces and use base class to return nicely"""
